...
import static com.qualcomm.ftcrobotcontroller.R.color.titlebarcolormod;
...
public class AutonomousSettings extends Activity implements AdapterView.OnItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.auto_settings_open);
        mp.start();
    ...
    public void updateAllianceColor(View v)
    {
        ...
        else if(allianceColor.getText().equals("Red Alliance"))
        {
            ...
            allianceColor.setTextColor(getResources().getColor(titlebarcolormod));
    ...
    public void applySettings (View v)
    {
        ...
        MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.auto_settings_close);
        mp.start();

        Intent launchNewIntent = new Intent(AutonomousSettings.this, FtcRobotControllerActivity.class);
        startActivityForResult(launchNewIntent, 0);
    }

    public void cancel (View v)
    {
        MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.auto_settings_cancel);
        mp.start();
